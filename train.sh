...
2)
  ...
  ;;
3)
  CUDA_VISIBLE_DEVICES=1 nohup python run_ddpg.py --expID 3 --use_gpu --video_count 0 --n_cycles 40000 --num_parallel_envs 300 --num_rollouts 300 --n_test_rollouts 420 --serial --point_cloud --pointnet_load_path 2 --no_save_buffer > run_ddpg.log 2>&1 &
  ;;
*)
