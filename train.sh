...
2)
  ...
  ;;
3)
  CUDA_VISIBLE_DEVICES=1 nohup python run_ddpg.py --expID 3 --use_gpu --video_count 0 --n_cycles 40000 --chunk 10 --point_cloud --pointnet_load_path 2 --no_save_buffer > run_ddpg.log 2>&1 &
  ;;
*)
